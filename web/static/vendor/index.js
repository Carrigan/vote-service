...
var _user$project$Models$Candidate = F3(
	function (a, b, c) {
		return {id: a, name: b, rank: c};
	});
var _user$project$Models$Election = F5(
	function (a, b, c, d, e) {
		return {candidates: a, id: b, name: c, seat_count: d, created_at: e};
	});
var _user$project$Models$ElectionList = function (a) {
	return {data: a};
};
...
var _user$project$Commands$fetchElection = F3(
	function (id, success, failure) {
		return A3(
			_elm_lang$core$Task$perform,
			failure,
			success,
...
var _user$project$Commands$electionListDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'data',
	_elm_lang$core$Json_Decode$list(_user$project$Commands$electionDecoder),
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Models$ElectionList));
var _user$project$Commands$fetchElectionsUrl = A2(
	_elm_lang$core$String$join,
	'/',
	_elm_lang$core$Native_List.fromArray(
		['', 'api', 'elections']));
var _user$project$Commands$fetchElections = F2(
