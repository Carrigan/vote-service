	...
	var object = _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'name',
				_1: _elm_lang$core$Json_Encode$string(election.name)
			},
				{
				ctor: '_Tuple2',
				_0: 'seats',
				_1: _elm_lang$core$Json_Encode$int(election.seats)
			},
				{
				ctor: '_Tuple2',
				_0: 'candidates',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, candidateSerializer, election.candidates))
			}
			]));
	var body = A2(
		...
		_elm_lang$core$Json_Encode$object(
			_elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: 'election', _1: object}
				])));
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('New Candidate')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Create Election')
					]))
			]));
};
